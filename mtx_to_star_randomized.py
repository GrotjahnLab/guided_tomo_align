...
if __name__ == "__main__":
    argparser = argparse.ArgumentParser(description='Use transformation matrices generated by chim_session_to_mtx.py \
                                                     ...
                                                     This script will output particle assignments SHUFFLED for control purposes.')
    ...
    # Here's where the shuffling happens:
    ...
    outname = '.'.join(args.template_star.split('/')[-1].split('.')[:-1])+'.random_init_from_Chimera.star'
