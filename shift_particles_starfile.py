...
if __name__ == "__main__":
    ...
    argparser.add_argument('--template_star',required=True, type=str,help='RELION *.star file containing particles to be shifted.')
    ...
    argparser.add_argument('--output_name',type=str,help='Name for output *.star file. Otherwise it will be called "<original name>.shifted.star".')
